    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-10 col-md-6">
                <form action="{{ route('admin.bags.update', $bagProduct->id ) }}" class="shadow p-3 mt-4" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

                    <h2 class="text-center mb-3">Edit <span class="text-primary">{{ $bagProduct->name }}</span></h2>
                    {{-- form input --}}
                        ...
                        <div class="form-group mt-4">
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control border-start-1 @error('name') is-invalid @enderror" 
                                        placeholder="Enter product name" value="{{ old('name', $bagProduct->name ) }}">
                                </div>
                                @error('name')
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="description_title" class="form-control border-start-1 @error('description_title') is-invalid @enderror" 
                                        placeholder="Enter description title" value="{{ old('description_title', $bagProduct->description_title) }}">
                                </div>
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    ...
                                    >{{ old('description', $bagProduct->description ) }}</textarea>
                                </div>
                                @error('description')
                                    <div class="text-danger mt-2 small">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="stock" class="form-control border-start-1 @error('stock') is-invalid @enderror" 
                                        placeholder="Enter stock" value="{{ old('stock', $bagProduct->stock ) }}">
                                </div>
                                @error('stock')
                                    <div class="text-danger mt-2 small">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="price" class="form-control border-start-1 @error('price') is-invalid @enderror" 
                                        placeholder="Enter price" value="{{ old('price', $bagProduct->price ) }}">
                                </div>
                                @error('price')
                                    <div class="text-danger mt-2 small">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="old_price" class="form-control border-start-1 @error('old_price') is-invalid @enderror" 
                                        placeholder="Enter old price" value="{{ old('old_price', $bagProduct->old_price ) }}">
                                </div>
                                @error('old_price')
                                    <div class="text-danger mt-2 small">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="category_id" class="form-select @error('category_id') is-invalid @enderror">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" {{ $bagProduct->category_id  == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="brand" class="form-control border-start-1 @error('brand') is-invalid @enderror" 
                                        placeholder="Enter product brand" value="{{ old('brand', $bagProduct->BagsDetails->brand ) }}">
                                </div>
                                @error('brand')
                                    <div class="text-danger mt-2 small">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="weight" class="form-control border-start-1 @error('weight') is-invalid @enderror" 
                                        placeholder="Enter product weight" value="{{ old('weight', $bagProduct->BagsDetails->weight) }}">
                                </div>
                                @error('weight')
                                    <div class="text-danger mt-2 small">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="size" class="form-control border-start-1 @error('size') is-invalid @enderror" 
                                        placeholder="Enter product size" value="{{ old('size', $bagProduct->BagsDetails->size) }}">
                                </div>
                                @error('size')
                                    <div class="text-danger mt-2 small">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="external_material" class="form-control border-start-1 @error('external_material') is-invalid @enderror" 
                                        placeholder="Enter product external_material" value="{{ old('external_material', $bagProduct->BagsDetails->external_material) }}">
                                </div>
