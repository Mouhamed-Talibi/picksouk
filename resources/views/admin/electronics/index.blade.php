...
@section('content')
<div class="container-fluid electronics-container">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Electronics Management</h1>
        <a href="{{ route('admin.electronics.create') }}" class="btn btn-primary d-inline-flex align-items-center">
    ...
    @if ($electronics->isEmpty())
        <div class="card empty-state">
            <div class="card-body">
                ...
                <h3 class="h5 mb-3">No Electronics Products Found</h3>
                <p class="mb-4">Get started by adding your first electronics product to the inventory.</p>
                <a href="{{ route('admin.electronics.create') }}" class="btn btn-primary">
    ...
    @else
        <div class="card shadow mb-4">
            <div class="card-header d-flex align-items-center justify-content-between py-3">
                <h6 class="m-0 font-weight-bold text-primary">Electronics Products</h6>
            ...
            <div class="card-body">
                    ...
                    <table class="table table-hover" id="productsTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('admin.electronics.edit', $product)}}" class="btn btn-sm btn-outline-primary action-btn me-2" title="Edit">
                ...
                @if($electronics->hasPages())
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <div class="text-muted">Showing {{ $electronics->firstItem() }} to {{ $electronics->lastItem() }} of {{ $electronics->total() }} results</div>
